Maki is a point of interest icon set made especially for use with MapBox maps. For more information on how to use Maki with MapBox, see documentation at https://mapbox.com/tilemill/docs/guides/using-maki-icons/.
...
• Based upon internationally recognized symbols when appropriate. Good sources for symbol precedents include AIGA symbols(https://www.aiga.org/symbol-signs/), and the Noun Project(http://thenounproject.com/).
